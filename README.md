# nvim-treesitter-queries-vimdoc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-vimdoc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-vimdoc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **vimdoc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-vimdoc",
...
- [ ] Changes are scoped to `vimdoc` — do not include files for other languages
